...
library(wbstats)
GINI<- wb_search("GINI")
SI.POV.GINI <- wb_data("SI.POV.GINI",country = "all", start_date = 2010)
...
6.  **Período que cubre las bases de datos:**
    ...
    El periodo para analizar es el año 2010 en todas las variables excepto en la
    variable de gasto en educación, de la cual se va a examinar su comportamiento
    tanto en el año 2000 y 2010.
